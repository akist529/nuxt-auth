...
<template>
  <div>
    <form @submit.prevent="register">
      ...
      <input v-model="username" type="email" placeholder="Email" data-testid="register-email">
      <input v-model="userid" type="text" placeholder="Username" data-testid="register-username">
